          ...
          <v-card>
            <v-container>
              <v-form @submit.prevent="addEvent">
                ...
                <v-text-field v-model="start" type="date" label="debut (required)"></v-text-field>
                <v-text-field v-model="end" type="date" label="fin (required)"></v-text-field>
                <v-text-field v-model="color" type="color" label="color (click to open menu color)"></v-text-field>
